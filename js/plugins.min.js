! function (t, i) {
    ...
    return i.defaults = {
        ...
        var h = i.attr("data-lightbox");
        if (h) {
            e = t(i.prop("tagName") + '[data-lightbox="' + h + '"]');
            for (var r = 0; r < e.length; r = ++r) s(t(e[r])), e[r] === i[0] && (o = r)
        } else if ("lightbox" === i.attr("rel")) s(i);
        else {
            e = t(i.prop("tagName") + '[rel="' + i.attr("rel") + '"]');
            for (var l = 0; l < e.length; l = ++l) s(t(e[l])), e[l] === i[0] && (o = l)
        }
        ...
        this.$lightbox.css({
            top: d + "px",
            left: g + "px"
        }).fadeIn(this.options.fadeDuration), this.options.disableScrolling && t("html").addClass("lb-disable-scrolling"), this.changeImage(o)
